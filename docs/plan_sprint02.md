...
- Multi-language
- Testing y documentación del sprint
...
| T2.2 | Crear formularios de alta y edición | Anouar y Eloi | 2 | Alta |
| T2.3 | Hacer que los cambios se reflejen dinámicamente | Anouar | 1 | Alta |
